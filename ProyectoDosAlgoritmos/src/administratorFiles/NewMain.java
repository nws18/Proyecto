...
//
        ...
        Product product0 = new Product(0, "Aceite", "Unidades", 1, 2, "Aceite de cocina", 0, 4, 2000, "images/products/aceite.png");
        Product product1 = new Product(1, "Arroz", "Paquetes", 8, 16, "Arroz, 2kg", 1, 4, 12500, "images/products/arroz.png");
        Product product2 = new Product(2, "Cereal", "Cajas", 10, 5, "Cereal", 2, 2, 10500, "images/products/cereal.png");
        Product product3 = new Product(3, "Chocolate", "Paquetes", 15, 5, "Chocolate relleno", 3, 5, 15500, "images/products/chocolate.png");
        Product product4 = new Product(4, "Coca cola", "Tarimas", 30, 20, "Bebida gaseosa", 4, 3, 40500, "images/products/cocacola.png");
        Product product5 = new Product(5, "Cono Kit-Kat", "Paquetes", 15, 10, "Helado de chocolate", 5, 5, 20500, "images/products/cono-kitkat.png");
        Product product6 = new Product(6, "Galletas", "Paquetes", 10, 3, "Galletas de crema", 6, 5, 10500, "images/products/galletas.png");
        Product product7 = new Product(7, "Salsa de tomate", "Cajas", 10, 9, "Salsa de tomate", 7, 2, 8500, "images/products/ketchup.png");
        Product product8 = new Product(8, "Limpiador", "Cajas", 7, 10, "Limpiador de superficies del hogar", 8, 1, 8000, "images/products/limpiador.png");
        Product product9 = new Product(9, "Enjuague bucal", "Paquetes", 20, 7, "Enjuague bucal", 9, 0, 14300, "images/products/listerine.png");
        Product product10 = new Product(10, "Mayonesa", "Cajas", 10, 6, "Aderezo mayonesa", 10, 2, 6000, "images/products/mayonesa.png");
        Product product11 = new Product(11, "Chocolate en polvo", "Paquetes", 6, 6, "Chocolate en polvo Nesquik", 11, 2, 6500, "images/products/nesquik.png");
        Product product12 = new Product(12, "Nuggets", "Paquetes", 5, 6, "Nuggets congelados para freír", 12, 5, 11500, "images/products/nuggets.png");
        Product product13 = new Product(13, "Palomitas", "Paquetes", 20, 3, "Palomitas de maíz, sabor mantequilla", 13, 5, 5000, "images/products/palomitas.png");
        Product product14 = new Product(14, "Pan", "Cajas", 10, 5, "Pan cuadrado para sandwiches", 14, 5, 5000, "images/products/pan.png");
        Product product15 = new Product(15, "Papas tostadas", "Cajas", 25, 15, "Papas tostadas en lata", 15, 5, 15200, "images/products/papasfritas.png");
        Product product16 = new Product(16, "Papel higienico", "Tarimas", 20, 10, "Papel higienico doble hoja", 16, 0, 17800, "images/products/papel.png");
        Product product17 = new Product(17, "Pasta dental", "Cajas", 20, 8, "Pasta dental", 17, 0, 9700, "images/products/pasta.png");
        Product product18 = new Product(18, "Shampoo", "Cajas", 15, 17, "Shampoo", 18, 0, 26300, "images/products/shampoo.png");
        Product product19 = new Product(19, "Spaghetti", "Paquetes", 10, 3, "Spaghetti", 19, 4, 10100, "images/products/spaghetti.png");
        Product product20 = new Product(20, "Té frío", "Tarimas", 25, 20, "Refresco natural", 20, 3, 32500, "images/products/te.png");
        Product product21 = new Product(21, "Limpiador Vanish", "Cajas", 14, 11, "Limpiador de ropa", 21, 1, 8000, "images/products/vanish.png");
        Product product22 = new Product(22, "Vino", "Cajas", 10, 11, "Bebida alcoholica", 22, 3, 35400, "images/products/vino.png");
